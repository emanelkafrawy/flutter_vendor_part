  ...
  Widget build(BuildContext context) {
    return Scaffold(
                      ...
                      Row(
                        ...
                        children: <Widget>[
                          CienmaSeat(
                            ...
                            isReserved: widget.id.get('seats')[10]
                                ["isReserved"],
                            movie: widget.id,
                          ),
                          CienmaSeat(
                            selectedId: widget.id.get('seats')[11]["id"],
                            isReserved: widget.id.get('seats')[11]
                                ["isReserved"],
                            movie: widget.id,
                          ),
                          CienmaSeat(
                            selectedId: widget.id.get('seats')[12]["id"],
                            isReserved: widget.id.get('seats')[12]
                                ["isReserved"],
                            movie: widget.id,
                          ),
                          CienmaSeat(
                            selectedId: widget.id.get('seats')[13]["id"],
                            isReserved: widget.id.get('seats')[13]
                                ["isReserved"],
                            movie: widget.id,
                          ),
                          SizedBox(
                          ...
                          CienmaSeat(
                            ...
                            isReserved: widget.id.get('seats')[14]
                                ["isReserved"],
                            movie: widget.id,
                          ),
                          CienmaSeat(
                            selectedId: widget.id.get('seats')[15]["id"],
                            isReserved: widget.id.get('seats')[15]
                                ["isReserved"],
                            movie: widget.id,
                          ),
                          CienmaSeat(
                            selectedId: widget.id.get('seats')[16]["id"],
                            isReserved: widget.id.get('seats')[16]
                                ["isReserved"],
                            movie: widget.id,
                          ),
                          CienmaSeat(
                            selectedId: widget.id.get('seats')[17]["id"],
                            isReserved: widget.id.get('seats')[17]
                                ["isReserved"],
                            movie: widget.id,
                          ),
                          CienmaSeat(
                            selectedId: widget.id.get('seats')[18]["id"],
                            isReserved: widget.id.get('seats')[18]
                                ["isReserved"],
                            movie: widget.id,
                          ),
                        ],
                      ...
                      Row(
                        ...
                        children: <Widget>[
                          CienmaSeat(
                            ...
                            isReserved: widget.id.get('seats')[19]
                                ["isReserved"],
                            movie: widget.id,
                          ),
                          CienmaSeat(
                            selectedId: widget.id.get('seats')[20]["id"],
                            isReserved: widget.id.get('seats')[20]
                                ["isReserved"],
                            movie: widget.id,
                          ),
                          CienmaSeat(
                            selectedId: widget.id.get('seats')[21]["id"],
                            isReserved: widget.id.get('seats')[21]
                                ["isReserved"],
                            movie: widget.id,
                          ),
                          CienmaSeat(),
                          ...
                          CienmaSeat(
                            ...
                            isReserved: widget.id.get('seats')[22]
                                ["isReserved"],
                            movie: widget.id,
                          ),
                          CienmaSeat(
                            selectedId: widget.id.get('seats')[23]["id"],
                            isReserved: widget.id.get('seats')[23]
                                ["isReserved"],
                            movie: widget.id,
                          ),
                          CienmaSeat(
                            selectedId: widget.id.get('seats')[24]["id"],
                            isReserved: widget.id.get('seats')[24]
                                ["isReserved"],
                            movie: widget.id,
                          ),
                          CienmaSeat(
                            selectedId: widget.id.get('seats')[25]["id"],
                            isReserved: widget.id.get('seats')[25]
                                ["isReserved"],
                            movie: widget.id,
                          ),
                          CienmaSeat(
                            selectedId: widget.id.get('seats')[26]["id"],
                            isReserved: widget.id.get('seats')[26]
                                ["isReserved"],
                            movie: widget.id,
                          ),
                        ],
                      ...
                      Row(
                        ...
                        children: <Widget>[
                          CienmaSeat(
                            ...
                            isReserved: widget.id.get('seats')[27]
                                ["isReserved"],
                            movie: widget.id,
                          ),
                          CienmaSeat(
                            selectedId: widget.id.get('seats')[28]["id"],
                            isReserved: widget.id.get('seats')[28]
                                ["isReserved"],
                            movie: widget.id,
                          ),
                          CienmaSeat(
                            selectedId: widget.id.get('seats')[29]["id"],
                            isReserved: widget.id.get('seats')[29]
                                ["isReserved"],
                            movie: widget.id,
                          ),
                          CienmaSeat(
                            selectedId: widget.id.get('seats')[30]["id"],
                            isReserved: widget.id.get('seats')[30]
                                ["isReserved"],
                            movie: widget.id,
                          ),
                          SizedBox(
                          ...
                          CienmaSeat(
                            ...
                            isReserved: widget.id.get('seats')[31]
                                ["isReserved"],
                            movie: widget.id,
                          ),
                          CienmaSeat(
                            selectedId: widget.id.get('seats')[32]["id"],
                            isReserved: widget.id.get('seats')[32]
                                ["isReserved"],
                            movie: widget.id,
                          ),
                          CienmaSeat(
                            selectedId: widget.id.get('seats')[33]["id"],
                            isReserved: widget.id.get('seats')[33]
                                ["isReserved"],
                            movie: widget.id,
                          ),
                          CienmaSeat(
                            selectedId: widget.id.get('seats')[34]["id"],
                            isReserved: widget.id.get('seats')[34]
                                ["isReserved"],
                            movie: widget.id,
                          ),
                          CienmaSeat(
                            selectedId: widget.id.get('seats')[35]["id"],
                            isReserved: widget.id.get('seats')[35]
                                ["isReserved"],
                            movie: widget.id,
                          ),
                        ],
                      ...
                      Row(
                        ...
                        children: <Widget>[
                          CienmaSeat(
                            ...
                            isReserved: widget.id.get('seats')[36]
                                ["isReserved"],
                            movie: widget.id,
                          ),
                          CienmaSeat(
                            selectedId: widget.id.get('seats')[37]["id"],
                            isReserved: widget.id.get('seats')[37]
                                ["isReserved"],
                            movie: widget.id,
                          ),
                          CienmaSeat(
                            selectedId: widget.id.get('seats')[38]["id"],
                            isReserved: widget.id.get('seats')[38]
                                ["isReserved"],
                            movie: widget.id,
                          ),
                          CienmaSeat(
                            selectedId: widget.id.get('seats')[39]["id"],
                            isReserved: widget.id.get('seats')[39]
                                ["isReserved"],
                            movie: widget.id,
                          ),
                          ...
                          CienmaSeat(
                            ...
                            isReserved: widget.id.get('seats')[40]
                                ["isReserved"],
                            movie: widget.id,
                          ),
                          CienmaSeat(
                            selectedId: widget.id.get('seats')[41]["id"],
                            isReserved: widget.id.get('seats')[41]
                                ["isReserved"],
                            movie: widget.id,
                          ),
                          CienmaSeat(
                            selectedId: widget.id.get('seats')[42]["id"],
                            isReserved: widget.id.get('seats')[42]
                                ["isReserved"],
                            movie: widget.id,
                          ),
                          CienmaSeat(
                            selectedId: widget.id.get('seats')[43]["id"],
                            isReserved: widget.id.get('seats')[43]
                                ["isReserved"],
                            movie: widget.id,
                          ),
                          CienmaSeat(
                            selectedId: widget.id.get('seats')[44]["id"],
                            isReserved: widget.id.get('seats')[44]
                                ["isReserved"],
                            movie: widget.id,
                          ),
                          CienmaSeat(
                            selectedId: widget.id.get('seats')[45]["id"],
                            isReserved: widget.id.get('seats')[45]
                                ["isReserved"],
                            movie: widget.id,
                          ),
                          CienmaSeat(
                            selectedId: widget.id.get('seats')[46]["id"],
                            isReserved: widget.id.get('seats')[46]
                                ["isReserved"],
                            movie: widget.id,
                          ),
                        ],
      ...
      floatingActionButton: FloatingActionButton(
        backgroundColor: Color(0xFFffc3a2),
        onPressed: () {
        ...
        foregroundColor: Color(0xFF425c5a),
      ),
    );
  }
}
